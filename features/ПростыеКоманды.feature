...
Сценарий: Получение помощи продукта
    ...
    Тогда Вывод команды "oscript" содержит "oscript-app-template v1.0"
    Тогда Вывод команды "oscript" содержит "Возможные команды:"
    Тогда Вывод команды "oscript" содержит "help     - Вывод справки по параметрам"
    Тогда Вывод команды "oscript" содержит "version  - Выводить версию приложения"
    И Код возврата команды "oscript" равен 0
...
Сценарий: Вызов исполняемого файла без параметров
    ...
    Тогда Вывод команды "oscript" содержит "oscript-app-template v1.0"
    Тогда Вывод команды "oscript" содержит "ОШИБКА - Некорректные аргументы командной строки"
    Тогда Вывод команды "oscript" содержит "Возможные команды:"
    Тогда Вывод команды "oscript" содержит "help     - Вывод справки по параметрам"
    Тогда Вывод команды "oscript" содержит "version  - Выводить версию приложения"
