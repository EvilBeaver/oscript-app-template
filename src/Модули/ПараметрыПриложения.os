...
// 
// Параметры:
//	ОбъектМенеджерПриложения - Модуль - Модуль менеджера приложения
Процедура НастроитьКомандыПриложения(Знач ОбъектМенеджерПриложения) Экспорт
	
	ОбъектМенеджерПриложения.ДобавитьКоманду(ИмяКомандыВерсия(), "КомандаVersion",             "Выводит версию приложения");
	ОбъектМенеджерПриложения.ДобавитьКоманду(ИмяКомандыПомощь(), "КомандаСправкаПоПараметрам", "Выводит справку по командам");
	//...
	// ОбъектМенеджерПриложения.ДобавитьКоманду("<Имя команды>", "<Класс реализации>", "<Описание команды>");
